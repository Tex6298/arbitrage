...
DATASET_SPECS: Tuple[DatasetSpec, ...] = (
    ...
    DatasetSpec(
        ...
        status="implemented_first_pass",
        note="Actual output truth, not curtailment truth; the next step is dispatch-down truth.",
    ),
    DatasetSpec(
        ...
        status="planned",
        note="Needs both forecast and observed weather so forecast error can be backtested.",
    ),
    DatasetSpec(
