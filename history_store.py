...
TRUTH_STORE_PRIMARY_KEYS: Dict[str, list[str]] = {
    ...
    "fact_model_candidate_compare_daily": ["window_date", "baseline_model_key", "candidate_model_key"],
    "dim_model_benchmark_window": ["benchmark_suite_name", "benchmark_window_key"],
    "fact_model_candidate_compare_window_daily": [
    ...
    "fact_model_candidate_compare_window": [
        "benchmark_suite_name",
        "benchmark_window_key",
        "baseline_model_key",
        "candidate_model_key",
    ],
    "fact_model_candidate_compare_suite": [
        "benchmark_suite_name",
        "suite_scope",
        "baseline_model_key",
        "candidate_model_key",
