...
DATASET_SPECS: Tuple[DatasetSpec, ...] = (
    ...
    DatasetSpec(
        ...
        status="implemented_first_pass",
        note="First pass now supports both a grouped-mean baseline and a stronger potential-ratio baseline over fact_curtailment_opportunity_hourly, and it is horizonized at explicit forecast offsets with forecast-origin timestamps and as-of feature lineage. This table remains the backtest audit trail and should never be recomputed silently.",
    ),
    DatasetSpec(
